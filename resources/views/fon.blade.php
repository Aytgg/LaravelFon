        ...
        <div class="col-sm-6">
            <ul class="nav nav-tabs btn-group btn-group-toggle float-left" role="tablist">
                ...
                <li role="presentation" class="px-1">
                    <a class="btn btn-sm btn-primary btn-simple" href="#priceChart1A" aria-controls="profile" role="tab"
                        data-toggle="tab">
                        1A
                    </a>
                </li>
                <li role="presentation" class="px-1">
                    <a class="btn btn-sm btn-primary btn-simple" href="#priceChart3A" aria-controls="profile" role="tab"
                        data-toggle="tab">
                        3A
                    </a>
                </li>
                <li role="presentation" class="px-1">
                    <a class="btn btn-sm btn-primary btn-simple" href="#priceChart1Y" aria-controls="profile" role="tab"
                        data-toggle="tab">
                        1Y
                    </a>
                </li>
                <li role="presentation" class="px-1">
                    <a class="btn btn-sm btn-primary btn-simple" href="#priceChart3Y" aria-controls="profile" role="tab"
                        data-toggle="tab">
                        3Y
                    </a>
                </li>
                        ...
                        <div class="py-1.5 px-4 flex justify-between items-center">
                            <div class="w-28">
                                <div class="flex space-x-1.5"><img
                                        alt="Batıçim Batı Anadolu Çimento Sanayii A.Ş. Şirket Logosu" data-state="closed"
                                        loading="lazy" width="28" height="28" decoding="async" data-nimg="1"
                                        class="rounded sheadow-lg" style="color:transparent"
